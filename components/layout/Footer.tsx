            ...
            <div className="mt-6 flex items-center gap-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-ink/[0.08] bg-ink/[0.02] text-ink/55 transition-colors hover:border-primary/25 hover:bg-primary/10 hover:text-primary"
                >
